...
outType         = "denserep" #EDIT ME!   #what the CNN is predicting
...
features,labels  = helperFuncs.getTargets("denserep")            #get the target vector for each CID
...
model.add(GRU(output_dim=1024,return_sequences=False))
model.add(Dropout(.2))
